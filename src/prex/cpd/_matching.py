...
def expectation_masked(
    ...
    """Do a single expectation step of the CPD algorithm where only some of the entries in the matrix
    ...
    Args:
        ...
        var (Float[Array, ""]): variance of the Gaussian kernel
        w (float): outlier probability
        mask (Float[Array, "m n"]): mask where nonzero entries indicate valid matches
