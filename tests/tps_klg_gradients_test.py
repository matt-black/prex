"""Pytest tests for TPS transformation analytical gradients (minimum-matching KL)."""

import jax
import jax.numpy as jnp

from prex.gmm.dist import kullback_leibler_gmm_approx_spherical
from prex.gmm.grad import tps as grad_tps
from prex.gmm.tps import make_basis_kernel, pack_params


def test_tps_klg_gradients_2d():
    """Test 2D KLG TPS analytical gradients against autodiff."""
    # setup test data
    n, m = 8, 6
    ...
    def loss_fn(p):
        ...
        return kullback_leibler_gmm_approx_spherical(
...
def test_tps_klg_gradients_3d():
    """Test 3D KLG TPS analytical gradients against autodiff."""
    # setup test data
    n, m = 8, 6
